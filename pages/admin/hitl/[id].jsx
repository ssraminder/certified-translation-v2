        ...
        <div className="rounded-lg bg-white p-4 ring-1 ring-gray-100">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <button onClick={()=>save('draft')} className="rounded-md border px-3 py-1.5 text-sm">Save as Draft</button>
              <button onClick={()=>save('send')} className="rounded-md bg-gray-900 px-3 py-1.5 text-sm font-medium text-white">Send to Customer</button>
            </div>
            <div className="border-t pt-3 mt-3 flex items-center gap-2">
              ...
              <button onClick={reject} className="rounded-md border border-red-300 text-red-700 px-3 py-1.5 text-sm">Reject Quote</button>
            </div>
          </div>
        </div>
      </div>
